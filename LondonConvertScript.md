This is the sample Converter Script for the Transport for London TransXChange export stream. Please visit the [LondonTXC2GTFS](LondonTXC2GTFS.md) page for details. This sample script is updated from time to time, but not maintained to track the ever changing operator licensing.
...
if [ -f $2/data.zip ]
then
	java -Xmx2300M -jar $TXC2GTFS/transxchange2GoogleTransit.jar $2/data.zip $2/GTFS -c $3
	tflrm $2/data.zip
else

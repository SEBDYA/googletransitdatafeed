...
class ServicePeriodValidationTestCase(ValidationTestCase):
  ...
  def testDatesInValidRange(self):
    """ start_date and end_date of ServicePeriod must be in [1900,2100] """
    ...
    period.day_of_week[0] = True
    self.ExpectInvalidValue(period, 'end_date', 
                            'date must be between the years 1900 and 2100')
    ...
    self.ExpectInvalidValue(period2, 'start_date', 
                            'date must be between the years 1900 and 2100')
    ...
    e = self.accumulator.PopException('InvalidValue')
    self.assertTrue(e.column_name == 'start_date')
    self.assertEqual('date must be between the years 1900 and 2100', e.value)
    self.assertEqual('18990101', e.reason)
    e.FormatProblem() #should not throw any exceptions
    e.FormatContext() #should not throw any exceptions
    
    e = self.accumulator.PopException('InvalidValue')
    self.assertTrue(e.column_name == 'end_date')
    self.assertEqual('date must be between the years 1900 and 2100', e.value)
    self.assertEqual('29991231', e.reason)
    e.FormatProblem() #should not throw any exceptions
    e.FormatContext() #should not throw any exceptions
    
  def testDateExceptionsInValidRange(self):
    ...
    e = self.accumulator.PopException('InvalidValue')
    self.assertTrue(e.column_name == 'date')
    self.assertEqual('date must be between the years 1900 and 2100', e.value)
    self.assertEqual('21070101', e.reason)
    e.FormatProblem() #should not throw any exceptions
    e.FormatContext() #should not throw any exceptions
    ...
    self.assertTrue(e.column_name == 'date')
    self.assertEqual('date must be between the years 1900 and 2100', e.value)
    self.assertEqual('10070102', e.reason)
    e.FormatProblem() #should not throw any exceptions
    e.FormatContext() #should not throw any exceptions
...
class CalendarTxtIntegrationTestCase(MemoryZipTestCase):
  ...
  def testDatesInValidRange(self):
    """ start_date and end_date values in calendars.txt must be in [1900,2100] 
    """
    self.SetArchiveContents(
        "calendar.txt",
        "service_id,monday,tuesday,wednesday,thursday,friday,saturday,sunday,"
    ...
    e = self.accumulator.PopException('InvalidValue')
    self.assertEquals('calendar.txt', e.file_name)
    self.assertEquals('start_date', e.column_name)
    self.assertEquals('date must be between the years 1900 and 2100', e.value)
    self.assertEquals('18990101', e.reason)
    
    e = self.accumulator.PopException('InvalidValue')
    self.assertEquals('calendar.txt', e.file_name)
    self.assertEquals('end_date', e.column_name)
    self.assertEquals('date must be between the years 1900 and 2100', e.value)
    self.assertEquals('21101231', e.reason)
     
    self.accumulator.AssertNoMoreExceptions()
    
  def testDateExceptionsInValidRange(self):
    """ date values in calendars_dates.txt must be in [1900,2100] """
    self.SetArchiveContents(
        "calendar.txt",
        "service_id,monday,tuesday,wednesday,thursday,friday,saturday,sunday,"
        "start_date,end_date\n"
    ...
    e = self.accumulator.PopException('InvalidValue')
    self.assertEquals('calendar_dates.txt', e.file_name)
    self.assertEquals('date', e.column_name)
    self.assertEquals('date must be between the years 1900 and 2100', e.value)
    self.assertEquals('18990815', e.reason)

...
"""Create a Google Transit Feed from the shuttle XML feed.
"""
...
class NoDupStopExceptionProblemReporter(transitfeed.ExceptionProblemReporter):
...
def SaveFeed(input, output):
  ...
  schedule.Validate(problems=NoDupStopExceptionProblemReporter())

...
class Schedule:
  ...
  def __init__(self, problem_reporter=default_problem_reporter):
    ...
    self._active_service_period = None
  ...
  def GetActiveServicePeriod(self):
    if not self._active_service_period:
      return self.NewActiveServicePeriod()
    else:
      return self._active_service_period
  ...
  def NewActiveServicePeriod(self):
    ...
    service_period = ServicePeriod(id=str(len(self.service_periods)))
    self._active_service_period = service_period
    # manually add because AddServicePeriodObject rejects a period with no
    # days enabled

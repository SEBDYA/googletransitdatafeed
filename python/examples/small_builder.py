...
trip.AddStopTime(stop1, schedule, departure_time='09:00:00')
trip.AddStopTime(stop2, schedule, arrival_time='09:15:00')

trip = route.AddTrip(schedule, headsign="To Suburbia")
trip.AddStopTime(stop1, schedule, arrival_time='17:30:00')
trip.AddStopTime(stop2, schedule, arrival_time='17:45:00')
